...
//@ServletSecurity(value = @HttpConstraint(rolesAllowed = {"AdminRole"}))   pt a fi accesat doar de un anumit rol
...
public class AddProduct extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect(request.getContextPath() + "/ProductCatalog");
    }
